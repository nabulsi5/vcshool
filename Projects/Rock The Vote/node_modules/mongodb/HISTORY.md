...
* Harden MessageHandler in appServer.js to avoid issues where we cannot find a callback for an operation.
...
* Added socketTimeoutMS and connectTimeoutMS to socket options for repl_set.js and appServer.js
...
* Correctly emit errors from appServer.js only wrapping errors that are strings
